...
local r = tonumber(minetest.settings:get("protector_radius")) or 8
...
minetest.register_craftitem("protector:tool", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		and not inv:contains_item("main", "protector:protect2")
		and not inv:contains_item("main", "protector:protect3") then
		...
		elseif inv:contains_item("main", "protector:protect3") then
